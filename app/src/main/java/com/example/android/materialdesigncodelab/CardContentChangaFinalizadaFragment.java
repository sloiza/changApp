...
import static com.example.android.materialdesigncodelab.CardContentChangaFinalizadaFragment.ContentAdapter.LENGTH;
import static com.example.android.materialdesigncodelab.CardContentChangaFinalizadaFragment.ContentAdapter.mIDS;

/**
 * Provides UI for the view with Cards.
 */
public class CardContentChangaFinalizadaFragment extends Fragment {
        ...
        public ViewHolder(LayoutInflater inflater, ViewGroup parent) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(context, DetailChangaFinalizadaActivity.class);
                    intent.putExtra(DetailChangaFinalizadaActivity.EXTRA_POSITION, idChanga);
